    ...
    <AppWapper>
      ...
      <View style={styles.container}>
        <View style={styles.noInternetGifContianer}>
          <FastImage 
           source={ImagePath.noInternetGif}
           style={styles.noInternetGif}
          />
        </View>
        <View style={styles.titleContainer}>
          <Text style={styles.yourOffline}>{StringsName.yourOffline}</Text>
          <Text style={styles.checkWiFidata}>{StringsName.checkWiFidata}</Text>
        </View>

        <View style={styles.bntContianer}>
          <ButtonComp
            title={StringsName.refreshPage}
            onPress={() => {
              Alert.alert("Alert");
            }}
          />
